      ...
      <div className={styles['poll']}>
...

        {
          (this.state.showPollQuestion && !this.state.viewable) ? (
            <form id="frmPollQuestion" role="form" onSubmit={this.pollQuestionSubmit}>
              <input
                type="pollQuestion" className="form-control" id="txtPollQuestion" ref="pollQuestion" placeholder="Ask a Question..."
                name="pollQuestion"
              />
            </form>
          ) : null
...

        {
          !this.state.showPollQuestion ? (
            <form id="formPollOption" role="form" onSubmit={this.pollOptionSubmit}>
              <input
                type="pollOption" className="form-control" id="txtPollOption" ref="pollOption" placeholder="Enter an Option"
                name="pollOption"
              />
            </form>
          ) : null
